...
public class FluorescenceAnalyzer_ implements PlugIn, Measurements {
	...
	UserDialog refDialog, targetDialog;
	...
	public void run(String arg0) {
		...
		refDialog = new UserDialog("Action Warning", "Draw reference area, then click OK.");
		targetDialog = new UserDialog("Action Warning", "Draw target area, then click OK.");
